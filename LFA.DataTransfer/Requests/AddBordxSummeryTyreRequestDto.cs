...
{
    public class AddBordxSummeryTyreRequestDto
    {
        ...
        public string KMSAtPolicySale { get; set; }
        ...
        public Int32 TreadDepth { get; set; }
        ...
        public string ExtensionDurationInMonths { get; set; }
        ...
        public string LicensingFee { get; set; }
