...
namespace TAS.Services.Entities
{
    public class Claim
    {
        ...
        public virtual decimal ClaimMileageKm { get; set; }
        ...
        public virtual Guid NewClaimId { get; set; }
        public virtual bool IsEndorsed { get; set; }
        ...
        public virtual decimal PartadjustedValue { get; set; }
        public virtual decimal LabouradjustedValue { get; set; }
        public virtual decimal SundryadjustedValue { get; set; }
        public virtual bool IsInvoiceSubmit { get; set; }
    }
}
