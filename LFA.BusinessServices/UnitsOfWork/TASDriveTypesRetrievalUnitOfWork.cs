...
{
    internal sealed class TASDriveTypesRetrievalUnitOfWork : UnitOfWork
    {
        ...
        public TASDriveTypesRetrievalUnitOfWork(Guid tpaId)
        {
            this.tpaId = tpaId;
        }
        ...
        public override void Execute()
        {
            ...
            try
            {
                ...
                List<DriveTypeResponseDto> driveTypeEntities = driveTypeEntityManager.GetDriveTypes();
