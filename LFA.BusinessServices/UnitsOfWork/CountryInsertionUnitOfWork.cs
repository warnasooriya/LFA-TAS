...
{
    internal sealed class CountryInsertionUnitOfWork : UnitOfWork
    {
        public CountryRequestDto Country;
        private string UniqueDbName = string.Empty;

        public CountryInsertionUnitOfWork(CountryRequestDto Country)
        {
        ...
        public override void Execute()
        {
            try
            {
                ...
                if (ce == null)
                {
                    bool result = CountryEntityManager.AddCountry(Country);
                    this.Country.CountryInsertion = result;
                    if (Country.CountryInsertion)
                    {
                        /* remove cache */
