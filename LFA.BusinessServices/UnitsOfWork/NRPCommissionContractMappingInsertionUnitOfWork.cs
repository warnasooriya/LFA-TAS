...
{
    internal sealed class NRPCommissionContractMappingInsertionUnitOfWork : UnitOfWork
    {
        public NRPCommissionContractMappingRequestDto NRPCommissionContractMapping;
       
        public NRPCommissionContractMappingInsertionUnitOfWork(NRPCommissionContractMappingRequestDto NRPCommissionContractMapping)
        {
        ...
        public override void Execute()
        {
            try
            {
                ...
                if (ce == null)
                {
                    bool result = NRPCommissionTypesEntityManager.AddNRPCommissionContractMapping(NRPCommissionContractMapping);
