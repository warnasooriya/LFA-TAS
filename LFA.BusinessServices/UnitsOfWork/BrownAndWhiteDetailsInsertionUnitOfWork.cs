...
{
    internal sealed class BrownAndWhiteDetailsInsertionUnitOfWork : UnitOfWork
    {
        public BrownAndWhiteDetailsRequestDto BrownAndWhiteDetails;
        private string UniqueDbName = string.Empty;
        public BrownAndWhiteDetailsInsertionUnitOfWork(BrownAndWhiteDetailsRequestDto BrownAndWhiteDetails)
        {
        ...
        public override void Execute()
        {
            try
            {
                ...
                if (ce == null)
                {
                    bool result = BrownAndWhiteDetailsEntityManager.AddBrownAndWhiteDetails(BrownAndWhiteDetails);
                    if (result) {
                        /* remove cache */
