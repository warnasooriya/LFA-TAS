...
{
    internal sealed class ExtensionTypesRetrievalUnitOfWork : UnitOfWork
    {
        ...
        public override void Execute()
        {
            ...
            try
            {
                ...
                List<ExtensionTypeResponseDto> ExtensionTypeEntities = EntityCacheData.GetExtensionTypes(UniqueDbName);
                ExtensionTypesResponseDto result = new ExtensionTypesResponseDto();
                result.ExtensionTypes = ExtensionTypeEntities;
                this.Result = result;
            }
            finally
            {
