...
{
    internal sealed class PremiumAddonTypesRetrievalUnitOfWork : UnitOfWork
    {
        ...
        public override void Execute()
        {
            ...
            try
            {
                ...
                List<PremiumAddonTypeResponseDto> PremiumAddonTypeEntities = EntityCacheData.GetPremiumAddonTypes(UniqueDbName);
                PremiumAddonTypesResponseDto result = new PremiumAddonTypesResponseDto();
                result.PremiumAddonTypes = PremiumAddonTypeEntities;
