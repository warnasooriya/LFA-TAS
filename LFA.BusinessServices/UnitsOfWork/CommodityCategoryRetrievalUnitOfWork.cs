...
namespace TAS.Services.UnitsOfWork
{
    internal sealed class CommodityCategoryRetrievalUnitOfWork:UnitOfWork
    {
        ...
        public CommodityCategoryRetrievalUnitOfWork(Guid commodityTypeId) {
        ...
        public override void Execute()
        {
            ...
            try
            {
                ...
                CommodityCategoryResponseDto CommodityCategoryEntity = CommodityCategoryEntityManager.GetCommodityCategoryById(CommodityCategoryId, commodityTypeId);
