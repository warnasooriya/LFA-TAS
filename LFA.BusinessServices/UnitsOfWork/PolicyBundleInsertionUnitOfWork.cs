...
{
    internal sealed class PolicyBundleInsertionUnitOfWork : UnitOfWork
    {
        public PolicyBundleRequestDto Policy;
       
        public PolicyBundleInsertionUnitOfWork(PolicyBundleRequestDto Policy)
        {
        ...
        public override void Execute()
        {
            try
            {
                ...
                {
                    bool result = PolicyEntityManager.AddPolicyBundle(Policy);
