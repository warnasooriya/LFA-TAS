...
{
	internal sealed class PoliciesRetrievalUnitOfWork : UnitOfWork
	{
		...
		public override void Execute()
		{
			...
			try
			{
				...
				List<PolicyInfo> PolicyEntities = PolicyEntityManager.GetPolicys();
				...
				foreach (var Policy in PolicyEntities)
				{
                    ...
                    pr.ContractExtensionPremiumId = Policy.ContractExtensionPremiumId;
                    ...
                    pr.Discount = Convert.ToDecimal(Policy.DiscountPercentage);
                    //pr.DiscountPercentage = Policy.DiscountPercentage;
