...
{
    internal sealed class InsurerConsortiumInsertionUnitOfWork : UnitOfWork
    {
        public InsurerConsortiumRequestDto InsurerConsortium;
       
        public InsurerConsortiumInsertionUnitOfWork(InsurerConsortiumRequestDto InsurerConsortium)
        {
        ...
        public override void Execute()
        {
            try
            {
                ...
                if (ce == null)
                {
                    bool result = InsurerEntityManager.AddInsurerConsortium(InsurerConsortium);
