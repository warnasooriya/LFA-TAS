...
{
    internal sealed class BrokerRetriveUnitOfWork:UnitOfWork
    {
        ...
        internal BrokerRetriveUnitOfWork(Guid bokerid)
        {
            this.BrokerId = bokerid;
        }

        public BrokerRetriveUnitOfWork()
        {
        ...
        public override void Execute()
        {
            try
            {
                ...
                if (this.BrokerId != null)
                {
                    ...
                    brokerlist = BrokerEntityManager.GetBrokerDetailsByBrokerId(this.BrokerId);
                }
                else 
                {
                    brokerlist = BrokerEntityManager.GetAllBrokers();
                }
