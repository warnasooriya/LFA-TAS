...
{
    internal sealed class LoginAuthUnitOfWork : UnitOfWork
    {
        ...
        public LoginAuthUnitOfWork(LoginRequestDto LoginRequest)
        {
        ...
        public override void Execute()
        {
            try
            {
                ...
                LoginResponseDto result = systemUserEntityManager.LoginAuth(LoginRequest, dbName);
                this.Result = result;
            }
            finally
            {
