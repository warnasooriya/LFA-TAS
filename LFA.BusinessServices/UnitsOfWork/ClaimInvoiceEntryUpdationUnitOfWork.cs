...
{
    internal sealed class ClaimInvoiceEntryUpdationUnitOfWork : UnitOfWork
    {
        public readonly ClaimInvoiceEntryRequestDto ClaimInvoice;
        public string Result { get; set; }

        public ClaimInvoiceEntryUpdationUnitOfWork(ClaimInvoiceEntryRequestDto _claimInvoice)
        {
        ...
        public override void Execute()
        {
            try
            {
                ...
                bool Result = claimInvoiceEntityManager.UpdatePart(ClaimInvoice);
