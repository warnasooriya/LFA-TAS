...
{
    internal sealed class ReinsurerConsortiumInsertionUnitOfWork : UnitOfWork
    {
        public ReinsurerConsortiumRequestDto ReinsurerConsortium;
       
        public ReinsurerConsortiumInsertionUnitOfWork(ReinsurerConsortiumRequestDto ReinsurerConsortium)
        {
        ...
        public override void Execute()
        {
            try
            {
                ...
                if (ce == null)
                {
                    bool result = ReinsurerEntityManager.AddReinsurerConsortium(ReinsurerConsortium);
