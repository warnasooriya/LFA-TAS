...
{
    internal sealed class BordxPaymentUpdationUnitOfWork : UnitOfWork
    {
        public BordxPaymentRequestDto BordxPayment;

        public BordxPaymentUpdationUnitOfWork(BordxPaymentRequestDto BordxPayment)
        {
        ...
        public override void Execute()
        {
            try
            {
                ...
                bool result = BordxPaymentEntityManager.UpdateBordxPayment(BordxPayment);
