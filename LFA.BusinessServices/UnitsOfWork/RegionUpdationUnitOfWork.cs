...
{
    internal sealed class RegionUpdationUnitOfWork : UnitOfWork
    {
        public RegionRequestDto Region;
        public RegionResponseDto ExPr;
        private string UniqueDbName = string.Empty;
        public RegionUpdationUnitOfWork(RegionRequestDto Region)
        {
        ...
        public override void Execute()
        {
            try
            {
                ...
                //if (ce.IsRegionExists == true)
                //{
                    bool result = RegionEntityManager.UpdateRegion(Region);
