...
{
    internal sealed class TASVariantsRetrievalUnitOfWork : UnitOfWork
    {
        ...
        public TASVariantsRetrievalUnitOfWork(Guid tpaId)
        {
            this.tpaId = tpaId;
        }
        ...
        public override void Execute()
        {
            ...
            try
            {
                ...
                List<VariantResponseDto> VariantEntities = VariantEntityManager.GetVariants();
                VariantsResponseDto result = new VariantsResponseDto();
                result.Variants = VariantEntities;
                this.Result = result;
            }
            finally
            {
