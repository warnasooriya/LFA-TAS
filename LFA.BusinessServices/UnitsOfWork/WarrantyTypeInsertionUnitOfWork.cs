...
{
    internal sealed class WarrantyTypeInsertionUnitOfWork : UnitOfWork
    {
        public WarrantyTypeRequestDto WarrantyType;
        private string UniqueDbName = string.Empty;
       
        public WarrantyTypeInsertionUnitOfWork(WarrantyTypeRequestDto WarrantyType)
        {
        ...
        public override void Execute()
        {
            try
            {
                ...
                if (ce == null)
                {
                    bool result = WarrantyTypeEntityManager.AddWarrantyType(WarrantyType);
                    this.WarrantyType.WarrantyTypeInsertion = result;
                    if (WarrantyType.WarrantyTypeInsertion)
                    {
                        /* remove cache */
