...
{
    internal sealed class SubmittedClaimRetrievalUnitOfWork :UnitOfWork
    {
        private readonly ClaimListRequestDto claimListRequestDto;
        public object Result { get; set; }

        public SubmittedClaimRetrievalUnitOfWork(ClaimListRequestDto _claimListRequestDto)
        {
        ...
        public override void Execute()
        {
            try
            {
                ...
                this.Result = ClaimEntityManager.GetAllSubmittedClaimsByUserId(claimListRequestDto);
            }
            finally
            {
                EntitySessionManager.CloseSession();
