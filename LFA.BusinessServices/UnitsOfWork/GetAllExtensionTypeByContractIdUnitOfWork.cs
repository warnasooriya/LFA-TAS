...
{
    internal sealed class GetAllExtensionTypeByContractIdUnitOfWork : UnitOfWork
    {
        ...
        public GetAllExtensionTypeByContractIdUnitOfWork(Guid ContractId, Guid ProductId, Guid DealerId, DateTime Date,
        ...
        public override void Execute()
        {
            try
            {
                ...
                this.Result = ContractEntityManager.GetAllExtensionTypeByContractId(
                        _ContractId,
                        _ProductId,
                        _DealerId ,
                        _Date,
