...
{
    internal sealed class EligibilityInsertionUnitOfWork : UnitOfWork
    {
        public EligibilityRequestDto Eligibility;
       
        public EligibilityInsertionUnitOfWork(EligibilityRequestDto Eligibility)
        {
        ...
        public override void Execute()
        {
            try
            {
                ...
                if (ce == null)
                {
                    bool result = EligibilityEntityManager.AddEligibility(Eligibility);
