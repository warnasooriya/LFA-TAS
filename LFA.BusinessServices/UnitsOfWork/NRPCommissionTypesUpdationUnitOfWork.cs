...
{
    internal sealed class NRPCommissionTypesUpdationUnitOfWork : UnitOfWork
    {
        public NRPCommissionTypesRequestDto NRPCommissionTypes;
        public NRPCommissionTypesResponseDto ExPr;
        private string UniqueDbName = string.Empty;
        public NRPCommissionTypesUpdationUnitOfWork(NRPCommissionTypesRequestDto NRPCommissionTypes)
        {
                ...
                if (dbName != "")
                {
                    ...
                    if (tasTpaConnString != "")
                    {
                        ...
                        if (JWTHelper.checkTokenValidity(Convert.ToInt32(ConfigurationData.tasTokenValidTime.ToString())))
                        {
                            ...
                            if (ce.IsNRPCommissionTypesExists == true)
                            {
                                return true;
                            }
                            else
        ...
        public override void Execute()
        {
            try
            {
                ...
                //if (ce.IsNRPCommissionTypesExists == true)
                //{
                    bool result = NRPCommissionTypesEntityManager.UpdateNRPCommissionTypes(NRPCommissionTypes);
