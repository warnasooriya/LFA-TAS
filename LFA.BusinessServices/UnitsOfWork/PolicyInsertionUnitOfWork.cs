...
{
    internal sealed class PolicyInsertionUnitOfWork : UnitOfWork
    {
        public PolicyRequestDto Policy;
       
        public PolicyInsertionUnitOfWork(PolicyRequestDto Policy)
        {
        ...
        public override void Execute()
        {
            try
            {
                ...
                if (ce == null)
                {
                    bool result = PolicyEntityManager.AddPolicy(Policy);
