...
{
    internal sealed class TASMakesRetrievalUnitOfWork : UnitOfWork
    {

        private string UniqueDbName = string.Empty;
        public MakesResponseDto Result
        {
            get;
            private set;
        }
        ...
        public TASMakesRetrievalUnitOfWork(Guid commodityTypeId, Guid tpaId)
        {
        ...
        public override void Execute()
        {
            ...
            try
            {
                ...
                List<MakeResponseDto> MakeEntities = EntityCacheData.GetMakes(UniqueDbName);
                MakesResponseDto result = new MakesResponseDto();
                result.Makes = MakeEntities.Where(a => a.CommodityTypeId == this.commodityTypeId).ToList();
                this.Result = result;
            }
            finally
            {
