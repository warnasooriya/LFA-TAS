...
{
    internal sealed class GetAllUsageTypesByTpaIdUnitOfWork : UnitOfWork
    {
        public object Result { get; set; }
        private readonly Guid _tpaId;

        public GetAllUsageTypesByTpaIdUnitOfWork(Guid tpaId)
        {
            _tpaId = tpaId;
        }
        ...
        public override void Execute()
        {
            try
            {
                ...
                this.Result = new UsageTypeEntityManager().GetAllUsageTypes();
            }
            finally
            {
