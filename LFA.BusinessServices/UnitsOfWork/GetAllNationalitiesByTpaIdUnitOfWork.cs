...
{
    internal sealed class GetAllNationalitiesByTpaIdUnitOfWork : UnitOfWork
    {
        public object Result { get; set; }
        private readonly Guid _tpaId;

        public GetAllNationalitiesByTpaIdUnitOfWork(Guid tpaId)
        {
            _tpaId = tpaId;
        }
        ...
        public override void Execute()
        {
            try
            {
                ...
                this.Result = new NationalityEntityManager().GetAllNationalities();
            }
            finally
            {
