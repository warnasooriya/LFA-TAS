...
{
    internal sealed class DealerLocationInsertionUnitOfWork : UnitOfWork
    {
        public DealerLocationRequestDto DealerLocation;

        public DealerLocationInsertionUnitOfWork(DealerLocationRequestDto DealerLocation)
        {
        ...
        public override void Execute()
        {
            try
            {
                ...
                if (ce == null)
                {
                    bool result = DealerLocationEntityManager.AddDealerLocation(DealerLocation);
