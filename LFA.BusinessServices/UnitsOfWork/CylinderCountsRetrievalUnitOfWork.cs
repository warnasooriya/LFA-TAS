...
{
    internal sealed class CylinderCountsRetrievalUnitOfWork : UnitOfWork
    {
        ...
        public override void Execute()
        {
            ...
            try
            {
                ...
                //List<CylinderCount> cylinderCountEntities = cylinderCountEntityManager.GetCylinderCounts();
