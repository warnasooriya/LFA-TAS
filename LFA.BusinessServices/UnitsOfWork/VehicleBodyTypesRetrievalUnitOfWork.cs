...
{
    internal sealed class VehicleBodyTypesRetrievalUnitOfWork : UnitOfWork
    {
        ...
        public override void Execute()
        {
            ...
            try
            {
                ...
                //List<VehicleBodyType> vehicleBodyTypeEntities = vehicleBodyTypeEntityManager.GetVehicleBodyTypes();
