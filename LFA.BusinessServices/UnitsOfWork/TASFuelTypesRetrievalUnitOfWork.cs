...
{
    internal sealed class TASFuelTypesRetrievalUnitOfWork : UnitOfWork
    {

        private string UniqueDbName = string.Empty;
        public FuelTypesResponseDto Result
        {
            get;
            private set;
        }
        ...
        public TASFuelTypesRetrievalUnitOfWork(Guid tpaId)
        {
            this.tpaId = tpaId;
        }
        ...
        public override void Execute()
        {
            ...
            try
            {
                ...
                List<FuelTypeResponseDto> fuelTypeEntities = EntityCacheData.GetFuelTypes(UniqueDbName);
                FuelTypesResponseDto result = new FuelTypesResponseDto();
                result.FuelTypes = fuelTypeEntities;
                this.Result = result;
            }
            finally
            {
