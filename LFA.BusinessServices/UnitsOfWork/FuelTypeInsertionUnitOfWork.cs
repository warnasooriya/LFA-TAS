...
{
    internal sealed class FuelTypeInsertionUnitOfWork : UnitOfWork
    {
        public FuelTypeRequestDto FuelType;
        private string UniqueDbName = string.Empty;
       
        public FuelTypeInsertionUnitOfWork(FuelTypeRequestDto FuelType)
        {
        ...
        public override void Execute()
        {
            try
            {
                ...
                if (ce == null)
                {
                    bool result = fuelTypeEntityManager.AddFuelType(FuelType);
