...
{
    internal sealed class UpdateClaimUnitOfWork:UnitOfWork
    {
        private ClaimUpdateRequestDto claimData;
        public object Result { get; set; }
        public Guid tpaId { get; set; }

        public UpdateClaimUnitOfWork(ClaimUpdateRequestDto _claimData)
        {
        ...
        public override void Execute()
        {
            try
            {
                ...
                this.Result = ClaimEntityManager.UpdateClaim(claimData, tpaId);
            }
            finally
            {
                EntitySessionManager.CloseSession();
