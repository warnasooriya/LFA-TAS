...
{
    internal sealed class PremiumAddonTypeUpdationUnitOfWork : UnitOfWork
    {
        public PremiumAddonTypeRequestDto PremiumAddonType;
        public PremiumAddonTypeResponseDto ExPr;
        private string UniqueDbName = string.Empty;
        public PremiumAddonTypeUpdationUnitOfWork(PremiumAddonTypeRequestDto PremiumAddonType)
        {
                ...
                if (dbName != "")
                {
                    ...
                    if (tasTpaConnString != "")
                    {
                        ...
                        if (JWTHelper.checkTokenValidity(Convert.ToInt32(ConfigurationData.tasTokenValidTime.ToString())))
                        {
                            ...
                            if (ce.IsPremiumAddonTypeExists == true)
                            {
                                PremiumAddonType.EntryDateTime = ce.EntryDateTime;
                                PremiumAddonType.EntryUser = ce.EntryUser;
                                return true;
                            }
                            else
                            {
        ...
        public override void Execute()
        {
            try
            {
                ...
                //if (ce.IsPremiumAddonTypeExists == true)
                //{
                    bool result = PremiumAddonTypeEntityManager.UpdatePremiumAddonType(PremiumAddonType);
