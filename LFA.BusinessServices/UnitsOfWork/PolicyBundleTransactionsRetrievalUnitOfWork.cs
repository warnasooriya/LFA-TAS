...
{
    internal sealed class PolicyBundleTransactionsRetrievalUnitOfWork : UnitOfWork
    {
       

        public PolicyBundleTransactionsResponseDto Result
        {
            get;
            private set;
        }
        ...
        public override void Execute()
        {
            ...
            try
            {
                ...
                List<PolicyBundleTransaction> PolicyEntities = PolicyEntityManager.GetPolicyBundleTransactions();


                PolicyBundleTransactionsResponseDto result = new PolicyBundleTransactionsResponseDto();
                result.Policies = new List<PolicyBundleTransactionResponseDto>();
                foreach (var Policy in PolicyEntities)
                {
                    PolicyBundleTransactionResponseDto pr = new PolicyBundleTransactionResponseDto();
