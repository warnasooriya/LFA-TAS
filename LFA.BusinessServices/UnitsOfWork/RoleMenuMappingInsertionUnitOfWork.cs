...
{
    internal sealed class RoleMenuMappingInsertionUnitOfWork : UnitOfWork
    {
        public RoleMenuMappingRequestDto RoleMenuMapping;
       
        public RoleMenuMappingInsertionUnitOfWork(RoleMenuMappingRequestDto RoleMenuMapping)
        {
        ...
        public override void Execute()
        {
            try
            {
                ...
                if (ce == null || ce.IsRoleMenuMappingExists == false)
                {
                bool result = RoleMenuMappingEntityManager.AddRoleMenuMapping(RoleMenuMapping);
