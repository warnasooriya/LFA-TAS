...
{
    internal sealed class PolicyTransactionInsertionUnitOfWork : UnitOfWork
    {
        public PolicyTransactionRequestDto PolicyEndorsement;

        public PolicyTransactionInsertionUnitOfWork(PolicyTransactionRequestDto PolicyEndorsement)
        {
        ...
        public override void Execute()
        {
            try
            {
                ...
                if (ce == null)
                {
                    bool result = PolicyEndorsementEntityManager.AddPolicyEndorsement(PolicyEndorsement);
                    this.PolicyEndorsement.PolicyInsertion = result;
                }
                else
                {
                    this.PolicyEndorsement.PolicyInsertion = false;
                }
