...
{
    internal sealed class BordxInsertionUnitOfWork : UnitOfWork
    {
        public BordxRequestDto Bordx;
       
        public BordxInsertionUnitOfWork(BordxRequestDto Bordx)
        {
        ...
        public override void Execute()
        {
            try
            {
                ...
                if (ce == null)
                {
                    bool result = BordxEntityManager.AddBordx(Bordx);
