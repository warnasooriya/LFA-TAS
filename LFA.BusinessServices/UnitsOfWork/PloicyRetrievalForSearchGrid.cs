...
{
    internal sealed class PloicyRetrievalForSearchGrid : UnitOfWork
    {
        private readonly PolicySearchGridRequestDto PolicySearchGridRequestDto;
        public object Result;
        public PloicyRetrievalForSearchGrid(PolicySearchGridRequestDto _PolicySearchGridRequestDto)
        {
        ...
        public override void Execute()
        {
            try
            {
                ...
                Result = policyEntityManager.GetPloiciesForSearchGrid(PolicySearchGridRequestDto);
