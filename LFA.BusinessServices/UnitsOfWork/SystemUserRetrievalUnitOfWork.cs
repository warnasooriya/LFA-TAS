...
{
    internal sealed class SystemUserRetrievalUnitOfWork : UnitOfWork
    {

        public string UserId;
        public SystemUserResponseDto Result
        {
            get;
            private set;
        }
        ...
        public override void Execute()
        {
            ...
            try
            {
                ...
                SystemUserResponseDto UserEntity = SystemUserEntityManager.GetUserById(UserId);
