...
{
    internal sealed class BrokerInsertionUnitOfWork:UnitOfWork
    {
        public BrokerRequestDto Broker {get;private set;}
        public bool Result { get; private set; }

        public BrokerInsertionUnitOfWork(BrokerRequestDto broker)
        {
            this.Broker = broker;
        }
        ...
        public override void Execute()
        {
            try
            {
                ...
                Result = BrokerEntityManager.SaveBroker(Broker);
