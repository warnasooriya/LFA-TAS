...
{
    internal sealed class RoleMenuLevelMappingInsertionUnitOfWork : UnitOfWork
    {

        public List<RoleMenuLevelMappingResponseDto> insertion
        {
            get;
            set;
        }
        ...
        public override void Execute()
        {
            ...
            try
            {
                ...
                bool userEntities = UserEntityManager.AddOrUpdateRoleMenuMapping(insertion);
