...
{
    internal sealed class CurrencyEmailInsertionUnitOfWork : UnitOfWork
    {
        public CurrencyEmailRequestDto CurrencyEmail;
       
        public CurrencyEmailInsertionUnitOfWork(CurrencyEmailRequestDto CurrencyEmail)
        {
        ...
        public override void Execute()
        {
            try
            {
                ...
                if (ce == null)
                {
                    bool result = CurrencyEntityManager.AddCurrencyEmail(CurrencyEmail);
