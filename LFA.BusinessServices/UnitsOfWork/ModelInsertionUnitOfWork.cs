...
{
    internal sealed class ModelInsertionUnitOfWork : UnitOfWork
    {
        public ModelRequestDto Model;

        public ModelInsertionUnitOfWork(ModelRequestDto Model)
        {
        ...
        public override void Execute()
        {
            try
            {
                ...
                if (ce == null)
                {
                    bool result = ModelEntityManager.AddModel(Model);
