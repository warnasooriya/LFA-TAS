...
{
    internal sealed class ContractInsertionUnitOfWork : UnitOfWork
    {
        public ContractRequestDto Contract;
        private string UniqueDbName = string.Empty;
        public ContractInsertionUnitOfWork(ContractRequestDto Contract)
        {
        ...
        public override void Execute()
        {
            try
            {
                ...
                if (ce == null)
                {
                    bool result = ContractEntityManager.AddContract(Contract);
                ...
                {
                    this.Contract.ContractInsertion = false;
                }
