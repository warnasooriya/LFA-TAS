app.controller('ReinsurerManagementCtrl', function ($scope, $rootScope, $http, SweetAlert, $localStorage, toaster) {
    ...
    $scope.AddReinsurer = function () {
        if ($scope.validateConsortium()) {
            ...
            if (exist.length == 0) {
                ...
                customWarningMessage("Already Added This Reinsurer")
            }
            ...
            customErrorMessage("Please Select Parent Reinsurer and Reinsurer.")
        }
    }
        ...
        if ($scope.RiskTotal != 100 || $scope.PercentageTotal != 100) { //|| $scope.NRPTotal != 100) {
            {
                ...
                //});
                customWarningMessage("Risk and Percentage Total Should be 100%.")
                return false;
            }
        }
        return true;
    ...
    $scope.ConsortiumSubmit = function () {
        if ($scope.ReinsurerConsortiums.length > 0 ) {
            ...
            customErrorMessage("Please Enter Consortium")
            ...
            if ($scope.ReinsurerContract.FromDate < $scope.ReinsurerContract.ToDate) {
                if ($scope.ReinsurerContract.Id == null || $scope.ReinsurerContract.Id == "00000000-0000-0000-0000-000000000000") {
                    ...
                    $http({
                        ...
                        if (data == "OK") {
                            SweetAlert.swal({
                                title: "Reinsurer Contract Information",
                                text: "Successfully Saved!",
                                confirmButtonColor: "#007AFF"
                            });
                            $http({
                ...
                SweetAlert.swal({
                    title: "Reinsurer Contract Information To Date should be greater than From date.",
                    text: "Error occured while saving data!",
                    type: "warning",
                    confirmButtonColor: "rgb(221, 107, 85)"
                });
        ...
        if (isGuid($scope.reinsurerStaff.reinsurerId)) {
            ...
            $http({
                ...
                if (data) {
                    ...
                    SweetAlert.swal({
                        title: "TAS Information",
                        text: "Reinsurer Staff Mapping Failed.",
                        type: "warning",
                        confirmButtonColor: "rgb(221, 107, 85)"
                    });
                    $scope.saveStaffMappingsBtnIconClass = "";
            ...
            customErrorMessage("Please select a Reinsurer.")
