app.controller('IncurredErningCtrl',
    function ($scope, $rootScope, $http, ngDialog, SweetAlert, $localStorage, $cookieStore, $filter, toaster) {
            ...
            //if ($scope.validateBordxPayment()) {
                //if ($scope.BordxPayment.Id != null && $scope.BordxPayment.Id != "00000000-0000-0000-0000-000000000000") {
                    ...
                    $http({
                        ...
                        if (data == "OK") {
                            SweetAlert.swal({
                                title: "IncurredErningProcess Information",
                                text: "Success!",
                        ...
                        SweetAlert.swal({
                            title: "IncurredErningProcess Information",
                            text: "Error occured while processing data!",
                            type: "warning",
        ...
        $scope.gridOptionsClaim = {
            ...
            columnDefs: [
                { name: 'ApprovedAmount', field: 'ApprovedAmount', enableSorting: false, cellClass: 'columCss' },
                { name: 'ClaimNumber', field: 'ClaimNumber', enableSorting: false, width: "*", cellClass: 'columCss' },
                { name: 'Date', field: 'Date', enableSorting: false, width: '30%', cellClass: 'columCss', },

                {
                    name: 'Is Good Will ',
                    cellTemplate: '<div class="center"><input type="checkbox" ng-model="true"/></div>',
                    width: 100,
                    enableSorting: false
                }
