    ...
    function ($scope, $rootScope, $http, ngDialog, $location, SweetAlert, $localStorage,
        ...
        $scope.viewClaim = function (claimReqId, make, model, dealer, date, claimStatus) {
            ...
            if (isGuid(claimReqId)) {
                ...
                $http({
                    ...
                    if (data.ProductCode.toUpperCase() == "TYRE") {
                        $scope.isProductTire = true;
                    ...
                    $scope.claimView.failureDate = data.FailureDate;
                    $scope.claimView.failureMileage = data.FailureMilege;
        ...
        $scope.getAllOriginalPolicyDetailsByClaimId = function (claimReqId) {
            $http({
                ...
                if (data.MWMonths == "0") {
                    $scope.claimView.oMWStart = "N/A";
                    $scope.claimView.oMWExp = "N/A";
                    $scope.claimView.oMWMonths = "N/A";
                    $scope.claimView.oMWMileage = "N/A";
                    $scope.claimView.oCutoffKm = "N/A";
                } else {
            ...
            if ($scope.isProductIloe) {
                if (isGuid(claimId)) {
                    ...
                    swal({
                        ...
                        cancelButtonText: $filter('translate')('common.button.cancel'),
