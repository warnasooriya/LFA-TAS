    ...
    function ($scope, $rootScope, $http, SweetAlert, ngDialog, $localStorage, toaster, $filter, $translate) {
        ...
        $scope.gridOptionsCustomer = {
            ...
            columnDefs: [
              { name: 'Id', field: 'Id', enableSorting: false, visible: false, cellClass: 'columCss' },
                { name: $filter('translate')('pages.customerManagement.firstName'), field: 'FirstName', enableSorting: false, cellClass: 'columCss' },
                { name: $filter('translate')('pages.customerManagement.lastName'), field: 'LastName', enableSorting: false, cellClass: 'columCss', },
                { name: $filter('translate')('pages.customerManagement.popUpSearchCustomer.mobileNo'), field: 'MobileNo', enableSorting: false, cellClass: 'columCss' },
                { name: $filter('translate')('pages.customerManagement.popUpSearchCustomer.eMail'), field: 'Email', enableSorting: false, cellClass: 'columCss' },
              {
                  name: ' ',
                  cellTemplate: '<div class="center"><button ng-click="grid.appScope.loadCustomer(row.entity.Id)" class="btn btn-xs btn-warning">' + $filter('translate')('common.button.update') +'</button></div>',
                  width: 60,
                  enableSorting: false
              }
            ],
        ...
        $scope.loadCustomer = function (customerId) {
            if (isGuid(customerId)) {
                ...
                swal({ title: $filter('translate')('common.alertTitle'), text: $filter('translate')('pages.customerManagement.errorMessages.requestingCustomerinformation'), showConfirmButton: false });
                   ...
                   // $scope.Customer.Id = value.Id;
                    $http({
                        ...
                        if (data.status == "Policy") {
                            ...
                            SweetAlert.swal({
                                title: $filter('translate')('pages.customerManagement.errorMessages.customerInformation'),
                                text: $filter('translate')('pages.customerManagement.errorMessages.policyEndorsement'),
                                type: "warning",
                            ...
                            SweetAlert.swal({
                                title: $filter('translate')('pages.customerManagement.errorMessages.customerInformation'),
                                text: $filter('translate')('pages.customerManagement.errorMessages.bordxEndorsement'),
                                type: "warning",
                                confirmButtonText: $filter('translate')('common.button.ok'),
                                confirmButtonColor: "rgb(221, 107, 85)"
                            });
        ...
        $scope.submit = function () {
            ...
            if ($scope.validateCustomer()) {
                if (!$scope.Customer.MobileNo.replace(/[\s]/g, '').match(phoneno)) { //|| !$scope.Customer.OtherTelNo.replace(/[\s]/g, '').match(phoneno)) {
                    customErrorMessage($filter('translate')('pages.customerManagement.errorMessages.validTelephone'))
                ...
                if ($scope.validation.userName) {
                    SweetAlert.swal({
                        title: $filter('translate')('pages.customerManagement.errorMessages.customerInformation'),
                        text: $filter('translate')('pages.customerManagement.errorMessages.emailAlreadyRegistered'),
                        type: "warning",
                        confirmButtonText: $filter('translate')('common.button.ok'),
                        confirmButtonColor: "rgb(221, 107, 85)"
                    });
                ...
                if ($scope.validation.password) {
                    SweetAlert.swal({
                        title: $filter('translate')('pages.customerManagement.errorMessages.customerInformation'),
                        text: $filter('translate')('pages.customerManagement.errorMessages.doesNotMatch'),
                        type: "warning",
                        confirmButtonText: $filter('translate')('common.button.ok'),
                        confirmButtonColor: "rgb(221, 107, 85)"
                    });
