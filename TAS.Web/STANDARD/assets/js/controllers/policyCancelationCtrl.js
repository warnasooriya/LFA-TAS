app.controller('PolicyCancelationCtrl', function ($scope, $rootScope, $http, ngDialog, SweetAlert, $localStorage, $cookieStore, $filter, toaster, $translate) {
    ...
    $scope.gridOptionsPolicy = {
        ...
        columnDefs: [
          { name: 'Id', field: 'Id', enableSorting: false, visible: false, cellClass: 'columCss' },
            ...
            {
                name: $filter('translate')('pages.policyCancelation.mobileNo'),
                field: 'MobileNo',
                enableSorting: false,
                cellClass: 'columCss'
            },
    ...
    $scope.loadPolicy = function (policyId) {
        if (isGuid(policyId)) {
            ...
            swal({
                ...
                text: $filter('translate')('pages.policyCancelation.readingInfor'),
    ...
    $scope.policyCancellation = function () {
        if (isGuid($scope.currentPolicyBundleId)) {
            ...
            if (typeof $scope.cancelationComment === 'undefined' || $scope.cancelationComment == '') {
                customErrorMessage($filter('translate')('pages.policyCancelation.cancelthisPolicy'));
            } else {
                swal({
                    ...
                    confirmButtonText: $filter('translate')('pages.policyCancelation.RequestIt'),
                    ...
                    if (isConfirm) {
                        ...
                        swal({
                            title: $filter('translate')('common.alertTitle'),
                            text: $filter('translate')('pages.policyCancelation.requestingCancellation'), showConfirmButton: false
                        });
                        $http({
                            method: 'POST',
                            ...
                            if (data == 'success') {
                                ...
                                $scope.policySaveStatusMsg = $filter('translate')('pages.policyCancelation.cancellationRequested');
