app.controller('PolicyRegCtrl',
    function ($scope, $rootScope, $http, ngDialog, SweetAlert, $localStorage, $cookieStore, toaster, $filter, FileUploader, $translate) {
        ...
        $scope.vwTyreDetails = false;
        $scope.additionalPolicyData = {
            Id: emptyGuid(),
            PolicyId: emptyGuid(),
            NumberOfTyreCover: '',
            FrontWidth: '',
        ...
        if ($localStorage.CommodityCode === "O") {
            $scope.comType = "Tyre";
            $scope.plicyWords = {
                "name": "Contract",
                "nameFl": "Contracts",
            ...
            $scope.plicyWords = {
                "name": $filter('translate')('pages.policyApproval.policy'),
                "nameFl": "Policies",
                "no": $filter('translate')('pages.policyCommonData.policyNo')
            };
        }
        ...
        $scope.customerDocUploader.onSuccessItem = function (item, response, status, headers) {
            if (response != 'Failed') {
                ...
                customErrorMessage($filter('translate')('pages.policyCommonData.errorMessage.errorUploadingAttachments'));
            ...
            fn: function (item, options) {
                if ($scope.customerAttachmentType != "" && typeof $scope.customerAttachmentType != 'undefined') {
                    if (item.size > 3000000) {
                        customErrorMessage($filter('translate')('pages.policyCommonData.errorMessage.maxSize'));
                        return false;
                    } else {
                        return true;
                    }
                } else {
                    customErrorMessage($filter('translate')('pages.policyCommonData.errorMessage.attachmentType'));
                    return false;
                }
        ...
        $rootScope.policySearch = {
            ...
            //Status: '',
            MobileNo: '',
            vinSerialName: $filter('translate')('pages.policyCommonData.vinSerial'),
            StartDate: '',
            EndDate: ''
        };
        ...
        if ($localStorage.CommodityCode === "O") {
            ...
            serchGridColumsn = [
                ...
                {
                    name: $filter('translate')('pages.policyCommonData.commodityType'),
                    field: 'CommodityType',
                    enableSorting: false,
                    cellClass: 'columCss'
                },
                {
                    name: $filter('translate')('pages.policyApproval.serviceContractNo'),
                    field: 'PolicyNo',
                    width: '30%',
                    enableSorting: false,
                    cellClass: 'columCss',
                ...
                {
                    name: $filter('translate')('pages.policyCommonData.mobilePhone'),
                    field: 'MobileNo',
                    enableSorting: false,
                    cellClass: 'columCss'
                },
                {
                    name: $filter('translate')('pages.policyCommonData.contractSoldDate'),
                    field: 'PolicySoldDate',
                    enableSorting: false,
                    cellClass: 'columCss'
                },
            ...
            serchGridColumsn = [
                { name: 'Id', field: 'Id', enableSorting: false, visible: false, cellClass: 'columCss' },
                { name: $filter('translate')('pages.policyCommonData.commodityType'), field: 'CommodityType', enableSorting: false, cellClass: 'columCss' },
                { name: $filter('translate')('pages.policyCommonData.policyNo'), field: 'PolicyNo', width: '30%', enableSorting: false, cellClass: 'columCss', },
                { name: $filter('translate')('pages.policyCommonData.vinSerial'), field: 'SerialNo', width: '20%', enableSorting: false, cellClass: 'columCss' },
                { name: $filter('translate')('pages.policyCommonData.mobilePhone'), field: 'MobileNo', enableSorting: false, cellClass: 'columCss' },
                { name: $filter('translate')('pages.policyCommonData.contractSoldDate'), field: 'PolicySoldDate', enableSorting: false, cellClass: 'columCss' },
        ...
        $scope.loadPolicy =  function (policyId) {
            ...
            if (typeof $scope.Products[0] != 'undefined' && typeof $scope.Products[0].Productcode != 'undefined' && $scope.Products[0].Productcode == "TYRE - ") {
                ...
                if (isGuid(policyId)) {
                    ...
                    $http({
                        ...
                        if (data == "Error occured") {
                            swal.close();
                            customErrorMessage($filter('translate')('pages.policyApproval.errorMessages.errorOccured'));
                            return;
                        }
                ...
                if (isGuid(policyId)) {
                    ...
                    loadingPolicyData = true;
                    SearchPolicyPopup.close();
                    swal({ title: $filter('translate')('common.loading'), text: $filter('translate')('pages.policyApproval.inforMessages.loadingPolicy'), showConfirmButton: false });
                    $http({
                        method: 'POST',
                        ...
                        // check manufacture warranty error response
                        if (data == "Manufacture Warranty Not Set For Selected Make & Country") {
                            swal.close();
                            SweetAlert.swal({
                                title: $filter('translate')('pages.policyCommonData.policyInformation'),
                                text: $filter('translate')('pages.policyApproval.errorMessages.manufactureWarrantyNotSet'),
                                type: "warning",
                        ...
                        $scope.selectedModelChange();
                        $scope.Policy.ProductId = data.ProductId;
                        $scope.additionalPolicyData = data.ContractProducts[0].PolicyAdditionalDetails;
                        $scope.Policy.Customer = data.Customer
                        $scope.Customer = data.Customer;
                        $scope.selectedCustomerTypeIdChanged();

                        // check Current Product IS IOLE
        ...
        $scope.gridOptionsCustomer = {
            ...
            columnDefs: [
                { name: 'Id', field: 'Id', enableSorting: false, visible: false, cellClass: 'columCss' },
                {
                    name: $filter('translate')('pages.policyCommonData.firstName'),
                    field: 'FirstName',
                    enableSorting: false,
                    cellClass: 'columCss'
                },
                {
                    name: $filter('translate')('pages.policyCommonData.lastName'),
                    field: 'LastName',
                    enableSorting: false,
                    cellClass: 'columCss',
                },
                ...
                {
                    name: $filter('translate')('pages.policyCommonData.email'),
                    field: 'Email',
                    enableSorting: false,
                    cellClass: 'columCss'
                },
        ...
        $scope.gridOptionsVehicle = {
            ...
            columnDefs: [
                { name: 'Id', field: 'Id', enableSorting: false, visible: false, cellClass: 'columCss' },
                {
                    name: $filter('translate')('pages.policyCommonData.vinNo'),
                    field: 'VINNo',
                    enableSorting: false,
                    cellClass: 'columCss'
                },
                {
                    name: $filter('translate')('pages.policyCommonData.plateNo'),
                    field: 'PlateNo',
                    enableSorting: false,
                    cellClass: 'columCss',
                },
        ...
        $scope.gridOptionsBAndW = {
            ...
            columnDefs: [
                { name: 'Id', field: 'Id', enableSorting: false, visible: false, cellClass: 'columCss' },
                {
                    name: $filter('translate')('pages.policyCommonData.serialNo'),
                    field: 'SerialNo',
                    enableSorting: false,
                    cellClass: 'columCss'
                },
                {
                    name: $filter('translate')('pages.policyCommonData.make'),
                    field: 'Make',
                    enableSorting: false,
                    cellClass: 'columCss'
                },
                {
                    name: $filter('translate')('pages.policyCommonData.model'),
                    field: 'Model',
                    enableSorting: false,
                    cellClass: 'columCss',
                },
        ...
        function loadInizialDataWithPageLoadingPartByPart() {
            ...
            $http({
                ...
                if (data.hasOwnProperty("GetAllCylinderCounts")) {
                    $scope.CylinderCounts = data.GetAllCylinderCounts;
                    // console.log('initializing CylinderCounts', $scope.CylinderCounts);
                }
        ...
        $scope.SetCommodityTypeValue = function () {
            ...
            if (result != null) {
                if (result.CommodityTypeDescription == "Automobile") {
                    ...
                    $scope.isProductILOE = true;
                    $scope.Policy.Type = "B&W";
                } else if (result.CommodityTypeDescription == "Tyre" && result.CommodityCode == "A") {
                    $scope.vwVehicleDetails = true;
                    $scope.vwBAndWDetails = false;
                    $scope.Policy.Type = "Vehicle";
                    $scope.vwTyreDetails = true;
            ...
            angular.forEach($scope.AllContractExtensions, function (valueC) {
                if (valueC.ContractId == $scope.Policy.ContractId && valueC.ExtensionTypeId == $scope.Policy.ExtensionTypeId && valueC.WarrantyTypeId == $scope.Policy.CoverTypeId) {
                    if ($scope.Policy.PolicySoldDate < valueC.StartDate || $scope.Policy.PolicySoldDate > valueC.EndDate) {
                        ...
                        SweetAlert.swal({
                            title: $filter('translate')('pages.policyCommonData.policyInformation'),
                            text: $filter('translate')('pages.policyApproval.inforMessages.contractValidPeriod'),
                            type: "warning",
                            confirmButtonText: $filter('translate')('common.button.ok'),
                            confirmButtonColor: "rgb(221, 107, 85)"
                        });
        ...
        $scope.SetPolicyCommodityTypeValue = function () {
            ...
            if ($scope.policySearch.CommodityType == undefined) {
                ...
                $scope.policySearch.vinSerialName = $filter('translate')('pages.policyCommonData.vinSerial');
            }
                            ...
                            $http({
                                ...
                                if (data == false) {
                                    SweetAlert.swal({
                                        ...
                                        text: $filter('translate')('common.errMessage.selectedDealer') + $scope.VehicleCurrency + $filter('translate')('common.errMessage.notDefinedCurrency'),
                                        type: "warning",
                                        confirmButtonColor: "rgb(221, 107, 85)"
                                    });
                                }
        ...
        $scope.loadContractExtension = function () {
            ...
            if (
                ...
                customErrorMessage($filter('translate')('pages.policyApproval.errorMessages.pleaseEnterProduct'));
            }
        }
        ...
        $scope.Submit = async function (e)  {
            ...
            if ($scope.Policy.ApprovedDate == null || $scope.Policy.ApprovedDate == undefined || $scope.Policy.ApprovedDate == "") {
                isValidated = false;
                $scope.validate_approvedDate = "has-error";
                customErrorMessage($filter('translate')('pages.policyApproval.errorMessages.enterApproveDate'));
                return false;
            } else {
                $scope.validate_approvedDate = "";
            }
            ...
            if ($scope.Products[0].Productcode == "TYRE - ") {
                ...
                if (!$scope.isUsedItem) {
                    ...
                    if ($scope.currentProductCode == 'ADT') {
                        $scope.ManufacturerWarranty.MWIsAvailable = false;
                    }
                    ...
                    angular.forEach($scope.CommodityTypes, function (value) {
                        if ($scope.Policy.CommodityTypeId == value.CommodityTypeId) {
                            if (value.CommodityTypeDescription == "Tyre") {
                                $scope.ManufacturerWarranty.MWIsAvailable = false;
                            }
                ...
                if ($scope.vwBAndWDetails && ($scope.BAndW.CategoryId == "" || $scope.BAndW.SerialNo == ""
                    ...
                    customErrorMessage($filter('translate')('pages.policyApproval.errorMessages.enterPolicyDetails'));
                    return;
                }
                if ($scope.vwVehicleDetails && ($scope.Vehicle.CategoryId == ""
                    || $scope.Vehicle.VINNo == ""
                    ...
                    || $scope.Vehicle.ItemPurchasedDate == "" || $scope.Vehicle.CommodityUsageTypeId == ""
                    || $scope.Vehicle.CommodityUsageTypeId == "00000000-0000-0000-0000-000000000000"
                    //|| $scope.Vehicle.PlateNo == ""
                ...
                var approveDate = new Date($scope.Policy.ApprovedDate);
                var soldDate = new Date($scope.Policy.PolicySoldDate);
                if (soldDate > approveDate) {
                    isValidated = false;
                    $scope.validate_approvedDate = "has-error";
                    customErrorMessage($filter('translate')('pages.policyApproval.errorMessages.approvedDateLess'));
                    return false;
                }

                if ($scope.vwVehicleDetails) {
                    swal({
                        title: $filter('translate')('pages.policyApproval.inforMessages.validating'),
                        text: $filter('translate')('pages.policyApproval.inforMessages.vinValidating'),
                        showConfirmButton: false
                    });
                    await $http({
                        method: 'POST',
                        url: '/TAS.Web/api/VehicleDetails/CheckMoreThanOneVehicleByWinNo',
                        data: { "vinNo": $scope.Vehicle.VINNo },
                        async: false,
                        headers: { 'Authorization': $localStorage.jwt == undefined ? jwt : $localStorage.jwt }
                        ...
                        if (response.data) {
                            isValidated = false;
                            customErrorMessage($filter('translate')('pages.policyApproval.inforMessages.vinAlreadyAllocated'));
                            e.preventDefault();
                            return false;
                        }
        ...
        $scope.savePolicyApprovalOtherTire = function () {
            ...
            $scope.Policy.UploadAttachments = $scope.uploadedDocIds;
            if ($scope.NoOfDateNoOfDate > 30) {
                customErrorMessage($filter('translate')('pages.policyApproval.errorMessages.policyExpired'));
                return false;
            }
            $scope.Policy.jwt = $localStorage.jwt;
            $scope.policySaveStatusTitle = $filter('translate')('common.processing');
            $scope.policySaveStatusMsg = $filter('translate')('pages.policyApproval.errorMessages.policyApprovalProcess');
            swal({ title: $scope.policySaveStatusTitle, text: $scope.policySaveStatusMsg, showConfirmButton: false });
            ...
            if ($scope.Policy.Id != null && $scope.Policy.Id != "00000000-0000-0000-0000-000000000000" && $scope.Policy.Id != "") {
                $http({
                    ...
                    if (data == "OK") {
                        ...
                        SweetAlert.swal({
                            title: $filter('translate')('pages.policyCommonData.policyInformation'),
                            text: $filter('translate')('pages.policyApproval.inforMessages.successfullySaved'),
                            confirmButtonText: $filter('translate')('common.button.ok'),
                ...
                SweetAlert.swal({
                    title: $filter('translate')('pages.policyCommonData.policyInformation'),
                    text: $filter('translate')('pages.policyApproval.errorMessages.cannotApprove'),
                    type: "warning",
                    confirmButtonText: $filter('translate')('common.button.ok'),
                    confirmButtonColor: "rgb(221, 107, 85)"
                });
        ...
        $scope.savePolicyApproval = function () {
            $scope.Policy.UploadAttachments = $scope.uploadedDocIds;
            $scope.policySaveStatusTitle = $filter('translate')('common.processing');
            $scope.policySaveStatusMsg = $filter('translate')('pages.policyApproval.inforMessages.approvalProcessed');
            swal({ title: $scope.policySaveStatusTitle, text: $scope.policySaveStatusMsg, showConfirmButton: false });
            ...
            if ($scope.x) {
                ...
                if (PaymentValidated) {
                    ...
                    SweetAlert.swal({
                        title: $filter('translate')('pages.policyCommonData.policyInformation'),
                        text: $filter('translate')('pages.policyApproval.inforMessages.pleaseConform'),
                        confirmButtonColor: "#007AFF",
                        type: "warning",
                        confirmButtonColor: "rgb(221, 107, 85)",
                        showCancelButton: true,
                        confirmButtonClass: "btn-danger",
                        confirmButtonText: $filter('translate')('pages.policyApproval.inforMessages.approvePolicy'),
                        closeOnConfirm: true
                    },
                        function (isConfirm) {
                            if (isConfirm) {
                    ...
                    customErrorMessage($filter('translate')('pages.policyApproval.errorMessages.paymentDetails'));
                    return false;
                }
            }
            else {
        ...
        $scope.SetAttributeSpecificationValue = function (contract) {
            ...
            if (isGuid(contract.AttributeSpecificationId)) {
                $http({
                    ...
                    if (data.length === 0)
                        customErrorMessage($filter('translate')('pages.policyCommonData.errorMessage.itemStatusnotmatch'));
        ...
        $scope.RemoveExistingAttachment = function (section, id) {
            ...
            if (isGuid(id)) {
                ...
                swal({
                    ...
                    confirmButtonText: $filter('translate')('common.removeIt'),
                    cancelButtonText: $filter('translate')('common.noCancel'),
                    closeOnConfirm: true,
                    closeOnCancel: true
                }, function (isConfirm) {
                    if (isConfirm) {
        ...
        $scope.downloadAttachment = function (ref) {
            if (ref != '') {
                console.log("ref",ref);
                swal({
                    title: $filter('translate')('common.processing'),
                    text: $filter('translate')('common.preparingDownload'),
                    showConfirmButton: false
                });
                $http({
                    method: 'POST',
        ...
        $scope.uploadAttachments = function () {
            if (!$scope.formAction) {
                ...
                var tempCustomerDocsQue = [];
                for (var j = 0; j < $scope.customerDocUploader.queue.length; j++) {
                    if (typeof $scope.customerDocUploader.queue[j].ref === 'undefined') {
                        //new records
                        tempCustomerDocsQue.push($scope.customerDocUploader.queue[j]);
                    }
                }
                $scope.customerDocUploader.queue = tempCustomerDocsQue;

                var tempitemDocQue = [];
                for (var j = 0; j < $scope.itemDocUploader.queue.length; j++) {
                    if (typeof $scope.itemDocUploader.queue[j].ref === 'undefined') {
                        //new records
                        tempitemDocQue.push($scope.itemDocUploader.queue[j]);
                    }
                }
                $scope.itemDocUploader.queue = tempitemDocQue;

                var tempPolicyDocQue = [];
                for (var j = 0; j < $scope.policyDocUploader.queue.length; j++) {
                    if (typeof $scope.policyDocUploader.queue[j].ref === 'undefined') {
                        //new records
                        tempPolicyDocQue.push($scope.policyDocUploader.queue[j]);
                    }
                }
                $scope.policyDocUploader.queue = tempPolicyDocQue;

                var tempPaymentDoQue = [];
                for (var j = 0; j < $scope.paymentDocUploader.queue.length; j++) {
                    if (typeof $scope.paymentDocUploader.queue[j].ref === 'undefined') {
                        //new records
                        tempPaymentDoQue.push($scope.paymentDocUploader.queue[j]);
                    }
                }
                $scope.paymentDocUploader.queue = tempPaymentDoQue;
            }
            ...
            if ($scope.customerDocUploader.queue.length > 0) {
                ...
                $scope.currentUploadingItem++;
                $scope.policySaveStatusTitle = $filter('translate')('pages.policyCommonData.inforMessage.uploadingCustomerAttachments');
                ...
                $scope.currentUploadingItem = 0;
                $scope.currentUploadingItem++;
                $scope.policySaveStatusTitle = $filter('translate')('pages.policyCommonData.inforMessage.uploadingItemAttachments');
                ...
                $scope.currentUploadingItem = 0;
                $scope.currentUploadingItem++;
                $scope.policySaveStatusTitle = $filter('translate')('pages.policyCommonData.inforMessage.uploadingPolicyAttachments');
                ...
                $scope.currentUploadingItem = 0;
                $scope.currentUploadingItem++;
                $scope.policySaveStatusTitle = $filter('translate')('pages.policyCommonData.inforMessage.uploadingPaymentAttachments');
                ...
                if ($scope.ImageArray.length > 0) {
                    swal({
                        title: $filter('translate')('common.uploading'),
                        text: $filter('translate')('pages.policyCommonData.inforMessage.uploadingImages'),
                        showConfirmButton: false
                    });
                    $http({
                        method: 'POST',
        ...
        */
        ...
        $scope.scannerPopUp = function (tabid) {
            ...
            if ($scope.customerAttachmentType == null || $scope.customerAttachmentType == 'undefined' || $scope.customerAttachmentType == "") {
                customErrorMessage($filter('translate')('pages.policyApproval.errorMessages.pleaseSelectAttachment'));
                return false;
            }
