app.controller('PartCtrl',
    function ($scope, $rootScope, $http, ngDialog, SweetAlert, $localStorage, $cookieStore, $filter, toaster, $translate) {
        ...
        $scope.labelSavePartArea = 'common.button.save';
        $scope.labelSavePart = 'common.button.save';
            ...
            if ($scope.validatePartArea()) {
                ...
                if ($scope.PartArea.Id == null || $scope.PartArea.Id == "00000000-0000-0000-0000-000000000000") {
                    ...
                    $http({
                        ...
                        if (data == "OK") {
                            SweetAlert.swal({
                                title: $filter('translate')('pages.partManagement.tabPartArea.partAreaInfor'),
        ...
        $scope.PartAreaValues = function () {
            ...
            if ($scope.PartArea.Id != null) {
                $http({
                    ...
                    $scope.labelSavePartArea = 'common.button.update';
                }).error(function (data, status, headers, config) {
                    clearPartAreaControls();
                });
            }
        ...
        $scope.selectedCommodityTypeChanged = function () {
            ...
            if (isGuid($scope.Part.CommodityId)) {
                $http({
                    ...
                    if (data == null)
                        customErrorMessage($filter('translate')('pages.dealerManagement.errorMessages.noPratArea'));
        ...
        $scope.getAllParts = function () {
            if (isGuid($scope.Part.PartAreaId)
                ...
                $http({
                    ...
                    if (data == null)
                        customErrorMessage($filter('translate')('pages.dealerManagement.tabPart.nopartsFound'));
                    $scope.parts = data;
                }).error(function (data, status, headers, config) {
                });
            }
        ...
        $scope.savePart = function () {
            if ($scope.validatePart()) {
                ...
                $http({
                    ...
                    if (data == "ok") {
                        SweetAlert.swal({
                            title: $filter('translate')('pages.dealerManagement.tabPart.partInformation'),
                            text: $filter('translate')('common.sucessMessages.successfullySaved'),
                            confirmButtonText: $filter('translate')('common.button.ok'),
                            confirmButtonColor: "#007AFF"
                        });
                        ...
                        SweetAlert.swal({
                            title: $filter('translate')('pages.dealerManagement.tabPart.partInformation'),
                            text: $filter('translate')('pages.dealerManagement.errorMessages.partDuplicate'),
                            type: "warning",
                            confirmButtonText: $filter('translate')('common.button.ok'),
                            confirmButtonColor: "rgb(221, 107, 85)"
                        });
        ...
        $scope.validatePartPrice = function () {
            ...
            if ($scope.PartPrice.CurrencyName == '') {
                customErrorMessage($filter('translate')('pages.dealerManagement.errorMessages.currencyNotfound'));
                isValid = false;
            } else {
        ...
        var customInfoMessage = function (msg) {
            toaster.pop('info', $filter('translate')('common.popUpMessages.warning'), msg, 12000);
        };
        ...
        $scope.selectedPartAreaChanged = function () {
            ...
            if (isGuid($scope.Part.PartAreaId) && isGuid($scope.Part.MakeId)) {
                $http({
                    ...
                    if (data == null)
                        customErrorMessage($filter('translate')('pages.dealerManagement.errorMessages.noPartsFound'));
