...
app.controller('PolicyEndorsementCtrl',
    function ($scope, $rootScope, $http, $parse, ngDialog, SweetAlert, $localStorage, $cookieStore, $filter, toaster, $state, FileUploader, $translate) {
        $scope.currentStep = 1;
        ...
        $scope.currencyPeriodCheck = function () {
            $http({
                ...
                if (data == true) {
                    ...
                    swal({
                        title: $filter('translate')('common.securityInformation'),
                        text: $filter('translate')('common.errMessage.noCurencyPeriod'),
                    ...
                    swal({
                        title: $filter('translate')('common.securityInformation'),
                        text: $filter('translate')('common.errMessage.errorCurrency'),
                        showConfirmButton: false
                    });
                    setTimeout(function () { swal.close(); }, 5000);
                    $state.go('app.dashboard');
        ...
        $scope.validityCheck = function () {
            $http({
                ...
                if (data == '' || data == null) {
                    swal({
                        title: $filter('translate')('common.securityInformation'),
                        text: $filter('translate')('common.errMessage.notAssigedanyBranch'),
                        showConfirmButton: false
                    });
                    $scope.allowedTpaBranches = [];
                    setTimeout(function () { swal.close(); }, 5000);
                                ...
                                $http({
                                    ...
                                    if (data == false) {
                                        SweetAlert.swal({
                                            ...
                                            text: $filter('translate')('common.errMessage.selectedDealer') + $scope.premiumCurrency + $filter('translate')('common.errMessage.notDefinedCurrency'),
                                            type: "warning",
        ...
        $scope.serialNumberCheck = function () {
            ...
            if (isGuid($scope.product.dealerId)) {
                if ($scope.formAction) {
                    ...
                    if (isGuid($scope.product.categoryId) && $scope.product.serialNumber != ''
                        ...
                        swal({
                            ...
                            text: $filter('translate')('pages.policyCommonData.inforMessage.validateVin'),
                            showConfirmButton: false
                        });
                        $http({
                            method: 'POST',
                            ...
                            if (data.IsSerialExist) {
                                if (data.IsDealerInvalid) {
                                    $scope.isProductDetailsReadonly = false;
                                    customInfoMessage($filter('translate')('pages.policyCommonData.inforMessage.allocatedAnotherDealer'));
                ...
                customErrorMessage($filter('translate')('pages.policyCommonData.errorMessage.selectDealer'));
            }
        ...
        $scope.gridOptionsPolicy = {
            ...
            columnDefs: [
                ...
                {
                    name: $filter('translate')('pages.policyCommonData.policyNo'),
                    field: 'PolicyNo',
                    width: '30%',
                    enableSorting: false,
                    cellClass: 'columCss',
                ...
                {
                    name: $filter('translate')('pages.policyCommonData.vinSerial'),
                    field: 'SerialNo',
                    width: '20%',
                    enableSorting: false,
                    cellClass: 'columCss'
                ...
                {
                    name: $filter('translate')('pages.policyCommonData.policySoldDate'),
        ...
        policyLoadingRequests = [
            ...
            if (isGuid(policyId)) {
                ...
                swal({
                    title: $filter('translate')('common.processing'),
                    text: $filter('translate')('pages.policyCommonData.inforMessage.loadingPolicyData'),
                    showConfirmButton: false
                });
                $http({
                    method: 'POST',
                    ...
                    if (data.IsEndorsementApprovalPending) {
                        customWarningMessage($filter('translate')('pages.policyEndorsement.inforMessage.endorsedAlready'));
                    ...
                    if ($scope.currentCommodityTypeCode == "A") {
                        ...
                        $scope.product.engineNumber = data.Vehicle.EngineNumber;
        ...
        $scope.gridOptionsVehicle = {
            ...
            columnDefs: [
                ...
                {
                    name: ' ',
                    cellTemplate: '<div class="center"><button ng-click="grid.appScope.loadVehicle(row.entity.Id)" class="btn btn-xs btn-warning">'
                        + $filter('translate')('common.button.load') + '</button></div>',
                    width: 60,
                    enableSorting: false
                }
            ],
        ...
        $scope.loadVehicleFromSerial = function (vehicleId) {
            if (isGuid(vehicleId)) {
                if (loadingstatus == false) {
                    ...
                    swal({
                        title: $filter('translate')('common.processing'),
                        text: $filter('translate')('pages.policyEndorsement.inforMessage.loadingVehicle'),
                        showConfirmButton: false
                    });
                $http({
                    method: 'POST',
        ...
        $scope.gridOptionsCustomer = {
            ...
            columnDefs: [
                ...
                {
                    name: $filter('translate')('pages.policyCommonData.businessName'),
                    field: 'BusinessName',
                    enableSorting: false,
                    cellClass: 'columCss',
                },
        ...
        $scope.loadCustomer = function (customerId) {
            if (isGuid(customerId)) {
                ...
                swal({
                    title: $filter('translate')('common.processing'),
                    text: $filter('translate')('pages.policyEndorsement.inforMessage.readingCustomerInfor'),
                    showConfirmButton: false
                });
                $http({
                    method: 'POST',
                ...
                if ($scope.product.serialNumber == "") {
                    ...
                    if (!$scope.formAction) {
                        if ($scope.product.serialNumber.length == parseInt($scope.serialNumberLength_temp)) {
                            ...
                            $scope.validate_serialNumber = "has-error";
                            isValidated = false;
                            customErrorMessage($filter('translate')('pages.policyCommonData.inforMessage.serialLength') + $scope.serialNumberLength_temp + $filter('translate')('pages.policyCommonData.inforMessage.characters'));
                        }
                    } else {
                        if ($scope.product.serialNumber.length == parseInt($scope.serialNumberLength)) {
                            ...
                            $scope.validate_serialNumber = "has-error";
                            isValidated = false;
                            customErrorMessage($filter('translate')('pages.policyCommonData.inforMessage.serialLength')
                                + $scope.serialNumberLength + $filter('translate')('pages.policyCommonData.inforMessage.characters'));
                        }
                    }
                }
                ...
                if ($scope.product.serialNumber == "") {
                    ...
                    if (!$scope.formAction) {
                        ...
                        if ($scope.product.serialNumber.length == parseInt($scope.serialNumberLength)) {
                            ...
                            $scope.validate_serialNumber = "has-error";
                            isValidated = false;
                            customErrorMessage($filter('translate')('pages.policyCommonData.inforMessage.serialLength') + $scope.serialNumberLength + $filter('translate')('pages.policyCommonData.inforMessage.characters'));
                        }
                    }
                            ...
                            if (!$scope.validatePaymentInfo()) {
                                ...
                                if ($scope.validateTpaBranch()) {
                                    if (isGuid($scope.policy.id)) {
                                        ...
                                        customErrorMessage($filter('translate')('pages.policyEndorsement.errorMessages.beforeEndorse'));
                                        isValidated = false;
                                        return;
                                    }
                                    ...
                                    customErrorMessage($filter('translate')('pages.policyCommonData.errorMessage.selectBranch'));
                                    isValidated = false;
                                    return;
                                }
                            }
        ...
        var errorMessage = function (i) {
            toaster.pop('error', $filter('translate')('common.popUpMessages.error'),
                $filter('translate')('pages.policyTransfer.errorMessage.pleaseComplete'));
        };
        ...
        var customWarningMessage = function (msg) {
            toaster.pop('warning', $filter('translate')('common.popUpMessages.warning'), msg, 20000);
        };
        ...
        $scope.manufactureWarrentyCheckForUsedItem = function () {
            swal({
                title: $filter('translate')('common.processing'),
                text: $filter('translate')('pages.policyEndorsement.inforMessage.checkingManufacturer'),
                showConfirmButton: false
            });
            var data = {
                makeId: $scope.product.makeId,
            ...
            $http({
                ...
                if (data.code === 'No') {
                    swal({
                        title: "",
                        text: $filter('translate')('pages.policyEndorsement.inforMessage.underManufacturerWarranty'),
                        type: "info",
                        showCancelButton: true,
        ...
        $scope.savePolicyEndorsment = function () {
            ...
            $scope.policySaveStatusMsg = $filter('translate')('pages.policyEndorsement.inforMessage.policyEndorsmentProcessed');
            swal({ title: $scope.policySaveStatusTitle, text: $scope.policySaveStatusMsg, showConfirmButton: false });
            ...
            $http({
                ...
                if (data == 'success') {
                    $scope.policySaveStatusTitle = $filter('translate')('pages.policyEndorsement.inforMessage.success');
                    $scope.policySaveStatusMsg = $filter('translate')('pages.policyEndorsement.inforMessage.endorsementSaved');
