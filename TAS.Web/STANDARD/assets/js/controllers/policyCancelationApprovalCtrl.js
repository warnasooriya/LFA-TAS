...
app.controller('PolicyCancelationApprovalCtrl', function ($scope, $rootScope, $http, ngDialog, SweetAlert, $localStorage, $cookieStore, $filter, toaster, $translate) {
    ...
    $scope.gridOptionsPolicy = {
        ...
        columnDefs: [
          { name: 'Id', field: 'Id', enableSorting: false, visible: false, cellClass: 'columCss' },
            ...
            {
                name: $filter('translate')('pages.policyEndorsementApproval.mobileNo'),
                field: 'MobileNo',
                enableSorting: false,
                cellClass: 'columCss'
            },
    ...
    $scope.loadPolicy = function (policyId) {
        if (isGuid(policyId)) {
            ...
            swal({
                ...
                text: $filter('translate')('pages.policyCancelationApproval.inforMessages.readinPolicy'),
    ...
    $scope.policyCancellationApprove = function () {
        if (isGuid($scope.currentPolicyBundleId)) {
            swal({
                ...
                confirmButtonText: $filter('translate')('pages.policyEndorsementApproval.yesApproveIt'),
                ...
                if (isConfirm) {
                    swal({
                        title: $filter('translate')('common.alertTitle'),
                        text: $filter('translate')('pages.policyCancelationApproval.inforMessages.approvingPolicy'),
                        showConfirmButton: false
                    });
                    $http({
                        method: 'POST',
                        ...
                        if (data == 'Success') {
                            $scope.policySaveStatusTitle = $filter('translate')('pages.policyCancelationApproval.inforMessages.success');
                            $scope.policySaveStatusMsg = $filter('translate')('pages.policyCancelationApproval.inforMessages.cancellationApproved');
                            ...
                            $scope.policySaveStatusTitle = $filter('translate')('pages.policyCancelationApproval.errorMessage.error');
            ...
            customErrorMessage($filter('translate')('pages.policyCancelationApproval.errorMessage.selectCancellation'));
        }
    }
    ...
    $scope.policyCancellationReject = function () {
        if (isGuid($scope.currentPolicyBundleId)) {
            swal({
                ...
                showCancelButton: true,
                confirmButtonColor: "#DD6B55",
                confirmButtonText: $filter('translate')('pages.policyEndorsementApproval.yesRejectIt'),
                cancelButtonText: $filter('translate')('common.noCancel'),
                closeOnConfirm: true,
                closeOnCancel: true
            }, function (isConfirm) {
                if (isConfirm) {
                    swal({
                        title: $filter('translate')('common.alertTitle'),
                        text: $filter('translate')('pages.policyCancelationApproval.inforMessages.rejectingPolicy'), showConfirmButton: false
                    });
                    $http({
                        method: 'POST',
                        ...
                        if (data == 'Success') {
                            ...
                            $scope.policySaveStatusMsg =
                                    $filter('translate')('pages.policyCancelationApproval.errorMessage.policyCancelationRejected');
                            $scope.policySaveStatusConfirmButtons = true;
                            swal({ title: $scope.policySaveStatusTitle, text: $scope.policySaveStatusMsg, showConfirmButton: true });
                            $scope.resetAll();
