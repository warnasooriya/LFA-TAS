app.controller('PolicyEndorsementApprovalCtrl', function ($scope, $rootScope, $http, ngDialog, SweetAlert, $localStorage, $cookieStore, $filter, toaster, $translate) {
    ...
    $scope.loadPolicy = function (policyId) {
        if (isGuid(policyId)) {
            ...
            swal({
                ...
                text: $filter('translate')('pages.policyEndorsementApproval.readingEndorsement'),
    ...
    $scope.approveEndorsementRequest = function () {
        if (isGuid($scope.currentPolicyBundleId))
        {
            swal({
                ...
                if (isConfirm) {
                    swal({
                        ...
                        text: $filter('translate')('pages.policyEndorsementApproval.approvingendorsement'),
                        showConfirmButton: false
                    });
                    $http({
                        method: 'POST',
                        ...
                        if (data == "Success")
                        {
                            ...
                            swal({
                                title: $filter('translate')('common.alertTitle'),
                                text: $filter('translate')('pages.policyEndorsementApproval.endorsementÄpproved'),
            ...
            customErrorMessage($filter('translate')('pages.policyEndorsementApproval.selectEndorsement'));
        }
    }
        ...
        if (isGuid($scope.currentPolicyBundleId)) {
            swal({
                ...
                if (isConfirm) {
                    swal({
                        title: $filter('translate')('common.processing'),
                        text: $filter('translate')('pages.policyEndorsementApproval.rejectingEndorsement'),
                        showConfirmButton: false
                    });
                    $http({
                        method: 'POST',
                        ...
                        if (data == "Success") {
                            ...
                            swal({
                                title: $filter('translate')('common.alertTitle'),
                                text: $filter('translate')('pages.policyEndorsementApproval.endorsementRejected'),
                                confirmButtonText: $filter('translate')('common.button.ok'),
                                showConfirmButton: true
                            });
