app.controller('ProductCtrl',
    function ($scope, $rootScope, $http, FileUploader, SweetAlert, $localStorage, $cookieStore, toaster, $filter, $translate) {
        ...
        $scope.IsExistsVarProductName = false;
        ...
        $scope.SetProductValues = function () {
            ...
            if ($scope.Product.Id != null) {
                $http({
                    ...
                    $scope.Product.productDisplayCode = data.ProductDisplayCode;
        ...
        function clearControls() {
            ...
            $scope.Product.productDisplayCode = "";
        ...
        $scope.validateProduct = function () {
            ...
            if ($scope.Product.productDisplayCode == "" || typeof $scope.Product.productDisplayCode == 'undefined') {
                $scope.validate_product_display_code = "has-error";
                isValid = false;
            } else {
                $scope.validate_product_display_code = "";
            }
            ...
            if (isValid) {
                ...
                if (isValid) {
                    if ($scope.IsExistsVarProductName) {
                        customWarningMessage($filter('translate')('pages.productManagement.productNamealreadyexists'))
